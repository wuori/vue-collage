<template>
    <div :class="['vc-slideshow-slide-inner', 'vc-slideshow-is-six', `vc-slideshow-is-six-${slideClass}`]">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            leftColumn(){
                return this.slideClass == 1 ? this.images.slice(0, 2) : this.images.slice(0, 2);
            },
            centerImg(){
                return this.slideClass == 1 && this.images[2] != null ? this.images[2] : null;
            },
            rightColumn(){
                return this.slideClass == 1 ? this.images.slice(3) : this.images.slice(2);
            }
        },
        methods: {
